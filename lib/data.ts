...
export const TEMPLATES = [
  {
    ...
    tasks: ["Bible Reading", "Morning Run", "Cold Shower", "Journaling"],
  ...
  },
  {
    ...
    tasks: ["Workout Session", "Protein Shake", "Stretch & Recovery", "Sleep 8hrs"],
  ...
  },
  {
    ...
    tasks: ["Read Bible", "Morning Prayer", "Evening Reflection", "Scripture Memory"],
  ...
  },
  {
    ...
    name: "Student Pack",
    icon: "📚",
    description: "Maximize academic performance",
    tasks: ["Lecture Review", "Flashcard Review", "Problem Sets", "Reading Goals"],
  ...
  },
  {
    ...
    name: "Developer",
    icon: "💻",
    description: "Stay sharp and ship consistently",
    tasks: ["Deep Work Block", "Code Review", "Learn Something New", "Side Project"],
  ...
  },
  {
    ...
    name: "House Cleaning",
    icon: "🏡",
    description: "Keep your space spotless",
    tasks: ["Kitchen Clean", "Laundry", "Vacuuming", "Bathroom Deep Clean"],
